...
export function HeroSection({ onOpenDemo }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#fbfcfb] via-[#f4f8f7] to-[#f7f9f8] pt-24 pb-12 sm:pt-32 sm:pb-20 lg:pt-36 lg:pb-24">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:col-span-5">
            ...
            {/* Actions */}
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 w-full sm:w-auto">
              <Button
                href="#contact"
                size="md"
                variant="primary"
                icon="arrow"
                iconPosition="right"
                className="w-full sm:w-auto bg-gradient-to-r from-teal-950 via-teal-900 to-teal-900 shadow-lg shadow-teal-950/20 hover:shadow-xl hover:shadow-teal-950/30 justify-center py-3.5"
              >
              ...
              >
                <span className="flex h-7 w-7 items-center justify-center rounded-full bg-teal-50 text-teal-800 transition-transform duration-200 group-hover:scale-110">
                  <Icon name="play" className="h-3 w-3 fill-teal-800 ml-0.5" />
                </span>
          ...
          >
            ...
            <div className="w-full max-w-sm rounded-3xl border border-teal-900/10 bg-white p-4 shadow-xl sm:hidden">
              <div className="flex items-center justify-between border-b border-brand-line/60 pb-3">
                <div className="flex items-center gap-2">
                  <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-teal-900 p-1 text-white">
                    <Icon name="qr" className="h-4 w-4" />
                  </div>
                  <div>
                    <b className="block text-xs font-bold text-brand-ink leading-tight">EQP-0001</b>
                    <small className="text-[10px] text-brand-muted">Groupe électrogène 500 KVA</small>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-2 my-3">
                <div className="rounded-xl border border-brand-line bg-brand-bg/50 p-2.5 text-left">
                  <span className="block text-[9px] text-brand-muted">Disponibilité</span>
                  <b className="font-sora text-sm font-bold text-brand-ink">86%</b>
                  <small className="text-[8px] text-emerald-700 font-semibold">+7 pts ce mois</small>
                </div>
                <div className="rounded-xl border border-brand-line bg-brand-bg/50 p-2.5 text-left">
                  <span className="block text-[9px] text-brand-muted">Prochaine maint.</span>
                  <b className="font-sora text-sm font-bold text-brand-ink">Service 500H</b>
                  <small className="text-[8px] text-teal-800 font-semibold">Dans 2 jours</small>
                </div>
              </div>
              ...
              <button
                type="button"
                onClick={onOpenDemo}
                className="w-full flex items-center justify-center gap-2 rounded-xl bg-teal-900 py-2.5 text-xs font-bold text-white shadow-md active:scale-98 transition-transform"
              >
                <Icon name="qr" className="h-3.5 w-3.5" />
                <span>Tester le scan de l'équipement</span>
              </button>
            </div>

            {/* TABLET & DESKTOP VIEW (sm+): Full 3D perspective dashboard & phone overlay */}
            <div className="hidden sm:block relative w-full h-[620px] lg:h-[650px] perspective-[1400px]">
              {/* Main 3D Dashboard Shell */}
              <div
                style={tiltStyle}
                className="absolute left-0 sm:left-2 top-8 w-full max-w-[610px] rounded-3xl border border-teal-900/10 bg-[#eef3f2] p-1.5 shadow-glow transition-transform duration-200 ease-out overflow-hidden"
              >
                {/* Window Header */}
            ...
            {/* Smartphone PWA Mockup Overlay (sm+) */}
