  ...
  return (
    <section id="product" className="relative bg-white py-16 sm:py-28 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-8 sm:mt-12 overflow-hidden rounded-3xl bg-gradient-to-r from-[#082f2e] via-[#0d4b49] to-[#126a65] p-6 sm:p-8 md:p-12 text-white shadow-glow">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5 sm:gap-6 lg:gap-8">
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div>
                ...
                <h3 className="mt-0.5 font-sora text-lg sm:text-xl md:text-2xl font-bold">
                  {valueBanner.title}
                </h3>
            ...
            <div className="flex flex-nowrap items-center gap-1.5 sm:gap-2 overflow-x-auto no-scrollbar flex-none w-full sm:w-auto pt-2 sm:pt-0">
              {valueBanner.flowSteps.map((step, idx) => (
                <React.Fragment key={idx}>
                  <span className="rounded-xl border border-white/15 bg-white/10 px-2.5 py-1 sm:px-3.5 sm:py-2 text-[11px] sm:text-xs font-bold tracking-tight backdrop-blur-md whitespace-nowrap flex-none">
                    {step}
                  </span>
