...
import { MotionFadeIn, MotionStagger, MotionItem, EASING_PREMIUM } from "../atoms/Motion";
...
export function ProblemSection() {
  ...
  return (
    <section id="product" className="relative bg-white py-14 sm:py-24 lg:py-32 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* DESKTOP ONLY (md+): 3 High-End Problem Cards Grid with Staggered Scroll Reveal */}
        <MotionStagger
          stagger={0.14}
          delay={0.08}
          className="hidden md:grid mt-12 lg:mt-16 grid-cols-3 gap-6"
        >
          {cards.map((card, idx) => (
            <MotionItem key={idx}>
              <article className="group relative flex flex-col justify-between rounded-3xl border border-slate-200/90 bg-gradient-to-b from-white via-[#fcfdfd] to-[#f8faf9] p-6 sm:p-7 shadow-xs transition-all duration-300 hover:-translate-y-1.5 hover:border-teal-300 hover:shadow-md overflow-hidden min-h-[290px] h-full">
                <div>
                ...
                {/* Concrete Impact Consequence Pill */}
        ...
        {/* Value Response Banner with Scale-in Scroll Reveal */}
        <MotionFadeIn
          delay={0.12}
          duration={0.7}
          className="relative mt-6 sm:mt-12 overflow-hidden rounded-3xl bg-gradient-to-r from-[#082f2e] via-[#0d4b49] to-[#126a65] p-4 sm:p-8 md:p-12 text-white shadow-glow"
        >
