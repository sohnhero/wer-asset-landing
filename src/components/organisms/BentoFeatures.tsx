...
export function BentoFeatures() {
  ...
  return (
    <section id="features" className="relative bg-[#f4f7f6] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <article className="relative lg:col-span-7 flex flex-col justify-between overflow-hidden rounded-3xl border border-teal-900/20 bg-gradient-to-br from-[#062e2d] via-[#0b4745] to-[#083533] p-8 sm:p-10 text-white shadow-glow min-h-[440px]">
          ...
          <article className="lg:col-span-5 flex flex-col justify-between rounded-3xl border border-brand-line/80 bg-white p-8 shadow-sm transition-all duration-300 hover:shadow-card">
            <div>
              ...
              <div className="space-y-1.5 mt-3">
                {bentoItems.preventive.tasks.map((task, idx) => (
                  <div key={idx} className="flex items-center justify-between rounded-xl bg-white border border-brand-line p-2 text-xs">
                    ...
                    <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${task.color === "red" ? "bg-rose-50 text-rose-700" : "bg-teal-50 text-teal-800"}`}>
                      {task.tag}
                    </span>
                  </div>
                ))}
          ...
          <article className="lg:col-span-4 flex flex-col justify-between rounded-3xl border border-brand-line/80 bg-white p-8 shadow-sm transition-all duration-300 hover:shadow-card">
            <div>
          ...
          <article className="lg:col-span-8 flex flex-col md:flex-row items-center justify-between gap-8 rounded-3xl border border-brand-line/80 bg-white p-8 sm:p-10 shadow-sm transition-all duration-300 hover:shadow-card">
          ...
          <article className="lg:col-span-12 flex flex-col md:flex-row items-center justify-between gap-8 rounded-3xl border border-brand-line/80 bg-white p-8 shadow-sm transition-all duration-300 hover:shadow-card">
